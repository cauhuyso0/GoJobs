...
public class ListJobFreelancerAdapter extends RecyclerView.Adapter<ListJobFreelancerAdapter.ViewHolder> {
    ...
    public ListJobFreelancerAdapter(Context context, ArrayList<Job> ds3, IItemRowClickedCallback iItemRowClickedCallback)
    {
